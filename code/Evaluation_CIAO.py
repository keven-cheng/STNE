...
def readNetworkData(dir, stemmer=0):#dir, directory of network dataset
    ...
    allvectors = []
    labelset = set()
    with open(dir + '/general_64_5.txt') as f1, open(dir + '/special_64_5.txt') as f2:
...
if __name__ == '__main__':
    directory = '../LABELS/CIAO' #data directory
    ...
    # text_save('CIAO_label.txt', vector_list)
